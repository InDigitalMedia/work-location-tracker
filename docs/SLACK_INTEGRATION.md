...
- **Daily Neal Street digest** — every weekday morning, a message goes to a configured channel: "Good morning team! ☕️ / Here's who's in the office today: / *names*" (real @mentions).
