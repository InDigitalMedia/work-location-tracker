...
- **Daily Neal Street digest** — every weekday morning, a message goes to a configured channel, in the same style as the week summary below: a bold "Here's who's at Neal Street today" header, a day section, and real @mentions.
